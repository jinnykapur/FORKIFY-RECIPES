  ...
  return (
    <div className='main' id='recipeView'>
      ...
      <div className='h-[155px] mx-4 flex justify-around items-center '>
        <div className='flex gap-10 md:gap-40'>
          <div className='flex flex-col md:flex-row md:gap-4 items-center'>
            <span className='text-[2rem] md:text-[2.75rem] uppercase text-[#af7e00]'>
          ...
          <div className='flex md:flex-row gap-2 md:gap-4 items-center'>
            <span className='text-[2.75rem] uppercase text-[#af7e00]'>
              <BsPeople />
            </span>
            <span className='md:text-[1.75rem] uppercase'>
            ...
            <span
              ...
              className='text-[2.5rem] text-[#af7e00] cursor-pointer'
            >
        ...
        <span
          ...
          className='text-[1.5rem] md:text-[2rem] uppercase bg-[#af7e00] text-white p-4 rounded-full cursor-pointer font-bold transition-all ease-in duration-300 hover:scale-110'
        >
      ...
      <div className=' bg-[#f2efee] py-[3rem] md:px-[4rem] '>
        <div className=' '>
          <span className='text-[2rem] text-[#af7e00] uppercase flex justify-center mb-8 font-bold tracking-[0.3rem]'>
            recipe ingredients
          </span>
